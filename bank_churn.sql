...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2021 at 08:32 PM
...
CREATE TABLE `bank_churn` (
  ...
  `NumOfProducts` double DEFAULT NULL,
  `HasCrCard` double DEFAULT NULL,
  `IsActiveMember` double DEFAULT NULL,
  `EstimatedSalary` double DEFAULT NULL,
  `Exited` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `bank_churn`
--

INSERT INTO `bank_churn` (`RowNumber`, `CustomerId`, `Surname`, `CreditScore`, `Geography`, `Gender`, `Age`, `Tenure`, `Balance`, `NumOfProducts`, `HasCrCard`, `IsActiveMember`, `EstimatedSalary`, `Exited`) VALUES
